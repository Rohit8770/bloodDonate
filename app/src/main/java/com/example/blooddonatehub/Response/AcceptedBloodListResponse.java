...
public class AcceptedBloodListResponse implements Serializable
{
    ...
    private final static long serialVersionUID = 7945541982954388299L;

    /**
     * No args constructor for use in serialization
     *
     */
    public AcceptedBloodListResponse() {
    }
     ...
     * @param status
     */
    public AcceptedBloodListResponse(List<GetBloodGroup> getBloodGroupList, String message, String status) {
        super();
